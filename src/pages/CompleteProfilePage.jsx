...
const CustomSlider = ({ value, onValueChange, min, max, step = 1 }) => {
  ...
  return (
    <div className="relative h-8 mb-4">
      ...
      <div className="absolute -bottom-6 left-2 text-xs text-gray-500">{min}</div>
...
export default function CompleteProfilePage() {
  ...
  const steps = [
    ...
    { id: "interests", title: "Intereses & Bio", icon: <Heart className="h-4 w-4" /> },
  ];
    ...
    if (validateCurrentStep()) {
      ...
      try {
        ...
        await axios.put(
          ...
          { ...formData, age: Number.parseInt(formData.age) },
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="gender" className={hasError("gender") ? "text-red-400" : ""}>
                  Género <span className="text-rose-500 ml-1">*</span>
                </Label>
                <RadioGroup
                  id="gender"
